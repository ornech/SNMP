...
> :warning: Avant de faire cet excercice vérifiez que vous avec les mibs HOST-RESOURCES-MIB et RFC1213-MIB soient chargées:  
> Déterminez le OID numérique (snmptranslate) et récupérez sa valeur (snmpget)
