...
Notez toute fois que les paraùètres renseignés dans snmp.conf peuvent supplanté en utilisant les options en ligne de commandes si vous avez besoin de changer certains paramètres.
